...
images_path = os.getcwd() + os.path.join("/img/")
filename_suffix = ".gif"
...
current_num_hero = 1
current_num_smallplane = 1
current_num_bigplane = 1
current_num_bee = 1
